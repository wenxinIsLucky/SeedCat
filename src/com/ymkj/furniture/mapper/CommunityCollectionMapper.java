...
public interface CommunityCollectionMapper {
	 ...
	 * @return
	 */
	public int addCommunityCollection(CommunityCollection communityCollection);
	 ...
	 * @return
	 */
	public List<CommunityCollection> findCommunityCollection(@Param("type")String type,@Param("start")int start,@Param("size")int size);
}
