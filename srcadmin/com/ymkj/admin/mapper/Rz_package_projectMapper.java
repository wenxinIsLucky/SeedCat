 ...
 * 2017年5月16日-下午5:22:00
 */
@Component("adminrz_package_projectMapper")
public interface Rz_package_projectMapper {
	/**
	 * 添加单条
	 * @author lucky(李文鑫) Email:578581198@qq.com
	 ...
	 * 查看套餐内指定项目的详细
	 * @author lucky(李文鑫) Email:578581198@qq.com
	 * 2017年5月24日-上午11:00:53
	 * @param rppid
	 * @return
	 */
	public Rz_package_project findRzProject(@Param("rppid")String rppid,@Param("rpid")String rpid);
	 ...
	 * @return
	 */
	public List<Rz_package_project> findRzProjectz(@Param("rpid")String rpid);
}
