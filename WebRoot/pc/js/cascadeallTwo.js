...
//获取xml文件
function cascdeInitTwo(v1,v2,v3) {
    //打开xlmdocm文档
    xmlDoc = loadXmlFile(urlsl+'pc/js/amyarea.xml');
    var dropElement1 = document.getElementById("sel-provance-two");
    var dropElement2 = document.getElementById("sel-city-two");
    var dropElement3 = document.getElementById("sel-area-two");
...
//依据省设置城市，县
*/
function selectCityTwo() {
    var dropElement1 = document.getElementById("sel-provance-two");
    var name = dropElement1.options[dropElement1.selectedIndex].value; 
    countyNodes = TopnodeList[dropElement1.selectedIndex];      
    var province = document.getElementById("sel-city-two");
    var city = document.getElementById("sel-area-two");
