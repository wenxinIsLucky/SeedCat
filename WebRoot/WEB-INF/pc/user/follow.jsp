...
<head>
<base href="<%=basePath%>">
<title>籽匠猫-我的关注</title>
<meta http-equiv="pragma" content="no-cache">
<meta http-equiv="cache-control" content="no-cache">
<meta http-equiv="expires" content="0">
<meta http-equiv="keywords" content="籽匠猫-我的关注">
<meta http-equiv="description" content="籽匠猫-我的关注">
	...
	<div class="Wrap">
		<div class="Right">
			...
			<dl class="Box">
				...
				<dd class="Friends">
					<ul class="visitorul">
						<li class="Cb" aj-id="13194829"><a class="Follow Followed"
							uid="13194829">已关注</a> <a class="Avatar" href="javascript:void(0);"> <img
						...
						<li class="Cb" aj-id="6720126"><a class="Follow Followed">已关注</a>
						...
						<li class="Cb"><a class="Follow Followed">已关注</a> <a
				...
				if(re.status==200){
					if(re.countPage != 0){
						$.each(re.list,function(i,v){
						    ...
						    strVar += "<a class=\"Avatar "+('${user.uid}'===v.follow.uid?'':'toVisitor')+"\" data-uid=\""+v.follow.uid+"\" href=\"javascript:void(0);\">";
						    ...
						    strVar += "<h2>";
						    strVar += "<a href=\"javascript:void(0);\" class=\""+('${user.uid}'===v.follow.uid?'':'toVisitor')+"\" data-uid=\""+v.follow.uid+"\">"+v.follow.name+"<\/a><i class=\""+(v.follow.sex=='0'?'Female':v.follow.sex=='1'?'Male':'0')+"\"><\/i><span class=\"Group\">Lv"+v.follow.lel+"."+v.follow.grade+"<\/span>";
						    strVar += "<\/h2>";
