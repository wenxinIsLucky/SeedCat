...
<div class="Wrap">
	<div class="Right">
		...
		<dl class="Box">
			<dt>
				我的动态（<span class="dongtaiCount">1</span>）
			</dt>
			<dd class="Trends">
				<ul class="BT0 MT0">
		...
		success : function(re) {
			if(re != null && re.list.length > 0){
				...
				$.each(re.list,function(i,v){
					 ...
					 strVar += "<li class=\"Ava\"><a class=\"Avatar\" href=\"javascript:void(0);\"><img src=\"/static_img/head/"+'${user.head}'+"\" alt=\""+'${user.name}'+"\" style=\"background: rgba(0, 0, 0, 0) none repeat scroll 0% 0%;\">";
