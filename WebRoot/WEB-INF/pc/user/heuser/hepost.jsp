...
<head>
<base href="<%=basePath%>">
<title>籽匠猫-他的拍客</title>
<meta http-equiv="pragma" content="no-cache">
<meta http-equiv="cache-control" content="no-cache">
<meta http-equiv="expires" content="0">
<meta http-equiv="keywords" content="籽匠猫-他的拍客">
<meta http-equiv="description" content="籽匠猫-他的拍客">
...
<body>
	<div class="Wrap">
		<div class="Right">
			<dl class="Box">
				<dt>
					他的拍客（<span class="hepostcount">1</span>）
				</dt>
				<dd class="Trends">
					<!-- <ul class="BT0 MT0">
...
<script type="text/javascript">
	...
	function jume(start,size,uid){
		$.ajax({
			type : 'POST',
			async : false,
			url : 'findCommunityHeData',
			data : {start:start,size:size,heuid:uid},
			success : function(re){
				if(re!=null){
					$('.hepostcount').text(re.dataCount);
					if(re.status===200 && re.list.length > 0){
						...
						$('.Trends').html("<p style=\"text-align: center;font-size: 22px;background-color: #f0f0f0;\">他很懒，还没有发表任何拍客</p>");
					}
				}
			},error : function(re){
				alert(re.status);
