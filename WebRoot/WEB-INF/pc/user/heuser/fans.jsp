...
<head>
<base href="<%=basePath%>">
<title>籽匠猫-他的粉丝</title>
<meta http-equiv="pragma" content="no-cache">
<meta http-equiv="cache-control" content="no-cache">
<meta http-equiv="expires" content="0">
<meta http-equiv="keywords" content="籽匠猫-他的粉丝">
<meta http-equiv="description" content="籽匠猫-他的粉丝">
				...
				if(re.status==200){
					if(re.countPage != 0){
						$.each(re.list,function(i,v){
						    ...
						    strVar += "<h2>";
						    strVar += "<a href=\"javascript:void(0);\" onclick=\"goVisitor('"+v.fans.uid+"')\">"+v.fans.name+"<\/a><i class=\""+(v.fans.sex=='0'?'Female':v.fans.sex=='1'?'Male':'0')+"\"><\/i><span class=\"Group\">Lv"+v.fans.lel+"."+v.fans.grade+"<\/span>";
						    strVar += "<\/h2>";
