...
<head>
<base href="<%=basePath%>">
<title>籽匠猫-视频工艺详情</title>
<meta http-equiv="pragma" content="no-cache">
<meta http-equiv="cache-control" content="no-cache">
<meta http-equiv="expires" content="0">
<meta http-equiv="keywords" content="籽匠猫-视频工艺详情">
<meta http-equiv="description" content="籽匠猫-视频工艺详情">
			...
			<div class="culture_left fl">
				...
				<div class="culture-con" style="width: 100%;">
					<video width="800" height="450"  controls="controls"  id="video1">
				      <source src="${technology.url}" type="video/mp4" />
				      <source src="${technology.url}" type="video/ogg" />
				      <source src="${technology.url}" type="video/webm" />
				      <object data="${technology.url}" width="800" height="450">
				        <embed src="${technology.url}" width="800" height="450" />
				      </object>
				    </video>
					${technology.content}
				</div>
				<div class="cul_shzng">
					<div class="cul_shzng1 fl">
						上一篇：<a href="javascript:void(0);" data-t="${technology.parentId}" title="${technology.parentTitle}">${fn:substring(technology.parentTitle,0,20)}</a>
					</div>
					...
					<div class="cul_shzng1 fr">
						下一篇：<a href="javascript:void(0);" data-t="${technology.nextId}" title="${technology.nextTitle}">${fn:substring(technology.nextTitle,0,20)}</a>
					</div>
					<div class="cl"></div>
				</div>
			</div>
		...
		$(function() {
			...
			$('.cul_shzng1 a').on('click',function(){
				...
				$.post('addTechnologyAllCount',param,function(re){
					location.href = 'getTechnologyDetailed?sid='+datat; 
				});
			});
