...
<head>
<base href="<%=basePath%>">
<title>籽匠猫-经典案例详情</title>
<meta http-equiv="pragma" content="no-cache">
<meta http-equiv="cache-control" content="no-cache">
<meta http-equiv="expires" content="0">
<meta http-equiv="keywords" content="籽匠猫-经典案例详情">
<meta http-equiv="description" content="籽匠猫-经典案例详情">
			...
			<div class="ny-title">
				...
				<div class="ny-title-right fl">
					<ul>
			          ...
			          <li><a href="to-technology-classic_case" class="tit_hover">经典案例</a></li>
			         </ul>
					<div class="cl"></div>
				</div>
				<div class="cl"></div>
		...
		<div class="culture">
			<div class="culture_left fl">
				<div class="culture_left_title">
					<h2>${classic_case.title}</h2>
					<ul>
						<li>发布时间：${fn:substring(classic_case.createDate,0,10)}</li>
						<li>| 作者：${classic_case.author} |</li>
						<li>点击：${classic_case.browse} |</li>
						<li class="danzd ${classic_case.fid==0?'':'yzan'}" data-t="${classic_case.ccid}" style="cursor: pointer;">点赞（${classic_case.zan}）</li>
						<li class="shouc ${classic_case.ccid==0?'':'yshouc'}" data-t="${classic_case.ccid}" style="cursor: pointer;">收藏（${classic_case.collection}）</li>
					</ul>
				</div>
				...
				<div class="cul_shzng">
					<div class="cul_shzng1 fl">
						上一篇：<a href="javascript:void(0);" data-t="${classic_case.parentId}" data-bs="${classic_case.type}" title="${classic_case.parentTitle}">${fn:substring(classic_case.parentTitle,0,20)}</a>
					</div>
					...
					<div class="cul_shzng1 fr">
						下一篇：<a href="javascript:void(0);" data-t="${classic_case.nextId}" data-bs="${classic_case.type}" title="${classic_case.nextTitle}">${fn:substring(classic_case.nextTitle,0,20)}</a>
					</div>
					<div class="cl"></div>
				</div>
			</div>
...
<script type="text/javascript">
		$(function() {
			...
			$('.cul_shzng1 a').on('click',function(){
				...
				$.post('addClassic_caseAllCount',param,function(re){
					location.href = 'getClassic_caseDetailed'+type+'?sid='+datat; 
				});
			});
