...
<html>
  <head>
	...
	<script type="text/javascript" src="pcadmin/yingzhuang/js/updjz_material.js"></script>
    ...
    <div id="rz-package-zong-div">
    	...
    	<div class="rz-package-info">
    		<div class="column-div">
    			...
    			<input class="i" type="text" vaben="${jm.jcid }" name="jcname" readonly="readonly" value="${jcname}"/>
    			<input class="i" type="hidden" vaben="${jpid}" name="jpname" readonly="readonly" value="${jpname}"/>
    		</div>
    		<div class="column-div">
    			<span class="span-name">材料名：</span>
    			<input class="i" type="hidden" name="jmid" value="${jm.jmid }"/>
    			<input class="i" type="text" name="jmname" value="${jm.jmname }"/>
    		</div>
    		
    		<div class="column-div">
    			<span class="span-name">材料信息：</span>
    			<textarea class="info" name="materialinfo" style="height: 200px;width: 400px;vertical-align: text-top;border: 1px solid #ccc;font-size: 16px;">${jm.materialinfo }</textarea>
    		</div>
    		
    		<div class="column-div">
    			<span class="span-name">材料说明：</span>
    			<textarea class="explain" name="materialexplain" style="height: 200px;width: 400px;vertical-align: text-top;border: 1px solid #ccc;font-size: 16px;">${jm.materialexplain }</textarea>
    		</div>
