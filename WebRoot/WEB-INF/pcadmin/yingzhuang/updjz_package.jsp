...
<html>
  ...
  <body>
    <div id="rz-package-zong-div">
    	...
    	<div class="rz-package-info">
    		...
    		<div class="column-div">
    			...
    			<input class="i" type="text" vaben="${tag}" name="jpname" value=""/>
    		</div>
    		
    		<div class="column-div">
    			<span class="span-name">套餐类型：</span>
    			<input class="i" type="text" name="jptype"/>
    		</div>
    		
    		<!-- <div class="column-div">
    			<span class="span-name">套餐价格：</span>
    			<input class="i" vali="number" type="text" name=""/>
    		</div> -->
    		
    		<div class="column-div">
    			<span class="span-name">套餐定制最低价格/㎡：</span>
    			<input class="i" vali="number" type="text" name="jpstartprice"/>
    		</div>
    		
    		<div class="column-div">
    			<span class="span-name">套餐主题理念：</span>
    			<textarea name="describe" style="height: 200px;width: 400px;vertical-align: text-top;border: 1px solid #ccc;font-size: 16px;"></textarea>
    		</div>
	...
	<script type="text/javascript" src="pcadmin/yingzhuang/js/updjz_package.js"></script>
</html>