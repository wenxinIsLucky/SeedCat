...
<script type="text/javascript" src="pcadmin/application/js/yingzhuang.js"></script>
	...
	<div id="show_post_div">
		...
		<table width="100%" class="title_table">
			<tr height="32px" align="center" bgcolor="#ccc">
				<td width="25%" class="td-title">提交时间</td>
				<td width="25%" class="td-title">预约人称呼</td>
				<td width="25%" class="td-title">预约人手机号码</td>
