...
<head>
<base href="<%=basePath%>">
<title>籽匠猫-免费设计服务申请管理</title>
<meta http-equiv="pragma" content="no-cache">
<meta http-equiv="cache-control" content="no-cache">
<meta http-equiv="expires" content="0">
<meta http-equiv="keywords" content="籽匠猫-硬装预约定制管理">
<meta http-equiv="description" content="籽匠猫-硬装预约定制管理">
...
<script type="text/javascript" src="pcadmin/application/js/designer_apply.js"></script>
	...
	<div id="show_post_div">
		...
		<table width="100%" class="title_table">
			<tr height="32px" align="center" bgcolor="#ccc">
				<td width="20%" class="td-title">申请时间</td>
				<td width="20%" class="td-title">称呼</td>
				<td width="20%" class="td-title">手机号码</td>
				<td width="20%" class="td-title">所在地区</td>
