...
<html>
  <head>
	...
	<script type="text/javascript" src="pcadmin/designer/js/upd_designer.js"></script>
    ...
    <div id="designer-zong-div">
    	...
    	<div class="designer-info">
    		...
    		<div class="column-div">
    			...
    			<input class="i" type="hidden" name="did" value="${designer.did }"/>
    			<input class="i" type="text" name="dname" value="${designer.dname }"/>
    		</div>
    		
    		<div class="column-div">
    			<span class="span-name">设计师等级：</span>
    			<input class="i" type="text" name="level" value="${designer.level }"/>
    		</div>
    		
    		<div class="column-div">
    			<span class="span-name">所在地：</span>
    			<input class="i" type="text" name="address" value="${designer.address }"/>
    		</div>
    		...
    		<div class="column-div">
    			...
    			<textarea name="style" style="height: 100px;width: 400px;vertical-align: text-top;border: 1px solid #ccc;font-size: 16px;">${designer.style }</textarea>
    		</div>
    		
    		<div class="column-div">
    			<span class="span-name">设计理念：</span>
    			<textarea name="idea" style="height: 200px;width: 400px;vertical-align: text-top;border: 1px solid #ccc;font-size: 16px;">${designer.idea }</textarea>
    		</div>
    		...
    		<div class="column-div">
				...
				<div class="contentDiv">
					<form id="form1" runat="server">
						<div>
							<!-- <a href="javascript:void(0);" class="file" > --><img src="/static_img/designer_img/${designer.head }" id="preview" style="width: 100px;height:140px;" alt=""/>
								<input id="file_upload" type="file" name="file" accept="image/*" capture="camera"/>
							<!-- </a> -->
							<span class="showFileName">${designer.head }</span>
					...
					<input class="head" type="hidden" name="head" value="${designer.head }"/>
				</div>
			</div>
			
			<div class="column-div">
    			<span class="span-name">联系手机：</span>
    			<input class="i" vali="number" type="text" name="phone" value="${designer.phone }"/>
    		</div>
    		
    		<div class="column-div">
    			<span class="span-name">Email：</span>
    			<input class="i" type="text" name="email" value="${designer.email }"/>
    			<input class="i" type="hidden" name="pularval" value="${designer.pularval }"/>
    		</div>
