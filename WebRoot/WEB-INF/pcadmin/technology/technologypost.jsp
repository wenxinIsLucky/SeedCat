...
<head>
<base href="<%=basePath%>">
<title>籽匠猫-添加籽匠工艺</title>
<meta http-equiv="pragma" content="no-cache">
<meta http-equiv="cache-control" content="no-cache">
<meta http-equiv="expires" content="0">
<meta http-equiv="keywords" content="籽匠猫-添加籽匠工艺">
<meta http-equiv="description" content="籽匠猫-添加籽匠工艺">
...
<body id="topBody">
	...
	<div class="publish" style="margin-top: 40px;">
		<div class="w1200" style="width: 880px;">
			<div class="publish_ti">添加籽匠工艺</div>
			<div class="publish_tit">
				<div class="publish_tit_left fl">籽匠工艺标题</div>
			...
			<div class="publish_tit">
				<div class="publish_tit_left fl">工艺类型</div>
				<div class="publish_tit_right fl">
			...
			<div class="publish_tit videodiv">
				<div class="publish_tit_left fl">视频链接&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
				<div class="publish_tit_right fl">
	...
	<script type="text/javascript">
		$(function() {
			...
			$('.fabiao').on('click', function() {
				...
				if(parseInt($('.selectType').val()) === 0 && $.trim($('input[name="videoUrl"]').val()).length <= 0){
					alert("请填写视频链接");
				...
				$.ajax({
					type: "POST",
					url: "addTechnologyData",
					data: {
						"title": e,
						"content": d,
						"type": parseInt($('.selectType').val()),
						"url" : $.trim($('input[name="videoUrl"]').val()),
						"cover": f
					},
					timeout: 20000,
