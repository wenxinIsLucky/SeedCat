...
<head>
<base href="<%=basePath%>">
<title>籽匠猫-文章管理</title>
<meta http-equiv="pragma" content="no-cache">
<meta http-equiv="cache-control" content="no-cache">
<meta http-equiv="expires" content="0">
<meta http-equiv="keywords" content="籽匠猫-文章管理">
<meta http-equiv="description" content="籽匠猫-文章管理">
...
<script type="text/javascript" src="pcadmin/culture/js/home_culture.js"></script>
	...
	<div id="show_post_div">
		<table width="100%" class="title_table">
			<caption>
				<!-- <h1>待审核拍客列表</h1> -->
				<div class="listpaike">
					<span class="current" data-sh="0">资讯文章</span>
					<span data-sh="1">籽匠潮流</span>
					<span data-sh="2">家居风水</span>
				</div>
				<div class="clear"></div>
			</caption>
